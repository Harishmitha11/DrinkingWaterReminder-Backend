...
const corsOptions = {
  origin: process.env.FRONTEND_URL || "https://drinkingwaterreminder-frontend.onrender.com",
...
// Routes
app.use('/api/auth', authRoutes);       // → https://backend/api/auth/...
app.use('/api/reminders', reminderRoutes);

app.get('/', (req, res) => res.send('Water Reminder API is running ✅'));
